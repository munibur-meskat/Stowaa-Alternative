                    ...
                    <ul class="cart_items_list ul_li_block mb_30 clearfix">
                        <li>
                            <div class="item_image">
                                <img src="{{ asset('assets/frontend/images/cart/cart_img_1.jpg') }}" alt="image_not_found">
                            </div>
                        ...
                        <li>
                            <div class="item_image">
                                ...
                                <img src="{{ asset('assets/frontend/images/cart/cart_img_2.jpg') }}" alt="{{ asset('frontend/images/cart/cart_img_2.jpg') }}">
                            </div>
                            <div class="item_content">
                                <h4 class="item_title">Yellow Blouse</h4>
                                <span class="item_price">$30.00</span>
                        ...
                        <li>
                            <div class="item_image">
                                <img src="{{ asset('assets/frontend/images/cart/cart_img_3.jpg') }}" alt="image_not_found">
                            </div>
                            <div class="item_content">
                                <h4 class="item_title">Yellow Blouse</h4>
                                <span class="item_price">$30.00</span>
                    ...
                    <div class="row">
                        <div class="col-lg-9 offset-lg-3">
                            <div class="main_slider" data-slick='{"arrows": false}'>
                                <div class="slider_item set-bg-image" data-background="{{ asset('assets/frontend/images/slider/slide-2.jpg') }}">
                                ...
                                <div class="slider_item set-bg-image" data-background="{{ asset('assets/frontend/images/slider/slide-3.jpg') }}">
                                    <div class="slider_content">
                                        <h3 class="small_title" data-animation="fadeInUp2" data-delay=".2s">Clothing</h3>
                                        <h4 class="big_title" data-animation="fadeInUp2" data-delay=".4s">Smart blood  <span>Pressure monitor</span></h4>
                                        <p data-animation="fadeInUp2" data-delay=".6s">The best gadgets collection 2021</p>
                                ...
                                <div class="slider_item set-bg-image" data-background="{{ asset('assets/frontend/images/slider/slide-1.jpg') }}">
                                    <div class="slider_content">
                                        <h3 class="small_title" data-animation="fadeInUp2" data-delay=".2s">Clothing</h3>
                                        <h4 class="big_title" data-animation="fadeInUp2" data-delay=".4s">Smart blood  <span>Pressure monitor</span></h4>
                                        <p data-animation="fadeInUp2" data-delay=".6s">The best gadgets collection 2021</p>
