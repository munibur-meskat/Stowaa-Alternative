              ...
              <div class="w-md-100">
                ...
                <form action="{{ route('dashboard.category.store') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control form-control-light" placeholder="name">
                  </div>

                  <div class="mb-3">
                    <label for="title" class="form-label">Category title</label>
    
                    <input type="text" name="title" class="form-control form-control-light" placeholder="title">
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <textarea name="description" class="form-control form-control-light" placeholder="description" rows="6"></textarea>
                  </div>
